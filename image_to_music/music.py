...
st.markdown(
    "This little app converts an image into a song. Play around with the various inputs belows using different images!")
...
st.sidebar.markdown(
    "Select sample image if you'd like to use one of the preloaded images. Select User Image is you'd like to use your own image.")
...
if img2load is not None:
    ...
    st.download_button('Download Song as CSV', data=convert_df_to_csv(song_df), file_name="song.csv", mime='text/csv',
                       key='download-csv')
